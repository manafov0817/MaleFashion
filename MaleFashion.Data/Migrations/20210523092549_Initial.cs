    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandsModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrandsModels_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DiscountWithPercent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DiscountWithNumber = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MainCategoryId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ProductMainCategoryMainCategoryId = table.Column<int>(type: "int", nullable: true),
                    ProductMainCategoryProductId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMainCategories", x => new { x.ProductId, x.MainCategoryId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.ProductMainCategoryProductId, x.ProductMainCategoryMainCategoryId },
